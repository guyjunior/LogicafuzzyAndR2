...
class _listint(Boost.Python.instance):
    ...
    def __iter__(self) -> typing.Any:
        """
            C++ signature :
                struct boost::python::objects::iterator_range<struct boost::python::return_value_policy<struct boost::python::return_by_value,struct boost::python::default_call_policies>,class std::_List_iterator<class std::_List_val<struct std::_List_simple_types<int> > > > __iter__(struct boost::python::back_reference<class std::list<int,class std::allocator<int> > & __ptr64>)
        """
...
class _vectdouble(Boost.Python.instance):
    ...
    def __iter__(self) -> typing.Any:
        """
            C++ signature :
                struct boost::python::objects::iterator_range<struct boost::python::return_value_policy<struct boost::python::return_by_value,struct boost::python::default_call_policies>,class std::_Vector_iterator<class std::_Vector_val<struct std::_Simple_types<double> > > > __iter__(struct boost::python::back_reference<class std::vector<double,class std::allocator<double> > & __ptr64>)
        """
    def __len__(self) -> int:
        """
            C++ signature :
...
class _vectint(Boost.Python.instance):
    ...
    def __iter__(self) -> typing.Any:
        """
            C++ signature :
                struct boost::python::objects::iterator_range<struct boost::python::return_value_policy<struct boost::python::return_by_value,struct boost::python::default_call_policies>,class std::_Vector_iterator<class std::_Vector_val<struct std::_Simple_types<int> > > > __iter__(struct boost::python::back_reference<class std::vector<int,class std::allocator<int> > & __ptr64>)
        """
    def __len__(self) -> int:
        """
            C++ signature :
